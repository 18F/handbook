---
title: Mission, history, and approach of TTS Consulting
---
...
| **Engagement scope** | Larger modernization efforts involving parallel projects in artificial intelligence, data analytics, cloud adoption, infrastructure optimization, contact center, and customer experience | Custom product development challenges which sometimes lead to expansions |
| **Staffing** | Federal employees with deep experience in key areas to serve as strategic leads and manage the work of vendors as contractor representatives (CORs) | Teams of federal employees in cross-functional teams of designers, engineers, product managers, and sometimes acquisition consultants |
| **Acquisitions** | Assisted acquisitions with trusted industry partners in a variety of disciplines and serves as CORs for those vendors | Acquisition coaching to help partners' run acquisitions through their own procurement shops |
...
Individual contributors from chapters occupy [various roles on engagements](#TODO).
...
- **Open by default.** We code and design in the open, use open-source software, use and build open source code, and evangelize our methods and practices across the federal government.
...
In its early years, 18F teams were focused on building shared services for government agencies, including:
...
In 2019, 18F shifted the focus of its work to consulting with agencies.
...
On October 24, 2017, the Office of American Innovation (OAI) established the IT Modernization Centers of Excellence within TTS to accelerate IT modernization across government to improve the public experience and increase operational efficiency. GSA implements the CoE program in partnership with OAI.

CoE originally launched with teams that provided technical expertise in six interrelated areas:
...
CoE’s approach to modernizing IT was to occur in three phases:

- An initial engagement period (two to four months), in which the Interagency Agreement (IAA) is developed and funding is identified
- A phase I period (six months), in which a comprehensive, department-wide assessment and planning effort is completed
- A phase II period (one to two years), in which the agreed-upon recommendations from phase I are implemented
