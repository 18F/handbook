...
View-only licenses are free! Any existing Airtable user should be able to grant you one by default by sharing view-only access to an existing base, but should you run into any difficulty, you can reach out in [#airtable-smartsheet](https://app.slack.com/client/T025AQGAN/C6YNTUPS9). All users must log into Airtable using the Single Sign On option.
