...
- **[Take a vote using emojis](#slack-vote).** When you have something that you need multiple people to decide on, you can pose a question and then list multiple options with emojis preset for others to react with. You can keep it simple with :redlight: , :yellowlight: and :greenlight: or use any one of the other [custom emojis](#custom emoji) to get creative. It is
