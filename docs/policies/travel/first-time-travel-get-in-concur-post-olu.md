...
5. Email completed CGE form to [civicactions-travel@gsa.gov](mailto:civicactions-travel@gsa.gov). _Do not email it to cge-access-requests@gsa.gov,_ as the form specifies. Only email it to civicactions-travel@gsa.gov.
...
Only traveler, unless you have already been instructed otherwise by the CivicActions travel team.
