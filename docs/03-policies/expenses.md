...
2.  Create a new card in the "Requests" column. Note that it is fine to group several related expenses (e.g. a complete trip including travel, accommodations and food) into a single card - please break out significant costs in the card description.
