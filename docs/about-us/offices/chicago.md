  ...
  <table class="table-office-metadata">
    <tbody>
      ...
      <tr>
        ...
        <td class="col-value">
        <a href="https://civicactions.slack.com/messages/@eth/">Ethan Heppner</a> (phone number is in the <a href="https://docs.google.com/spreadsheets/d/1QqqS_-V44MHyVqRIyHj6Eojg1Oz5EC3fS3j1e3mDrkg/edit#gid=3">CivicActions team contact info sheet</a>)
        </td>
      </tr>
      <tr>
        <td class="col-key">
      ...
      <tr>
       ...
       CivicActions&rsquo;s office is in suite 3780 in the southeast corner of the 37th floor.
        </td>
      </tr>
      <tr>
...
Public transit is from O'Hare to the CivicActions Chicago office is cheap, fairly quick, and convenient. Blue Line trains run from the airport to downtown 24/7 and take about 50 minutes. The closest stop to the office is **Jackson**.

### <a id="from-midway"></a>From Midway Airport

The smaller of the two Chicago airports, this one is a little closer to downtown-- it's only a 25 minute ride down the CTA Orange Line. The **Library/State & Van Buren** stops are the closest to the CivicActions office on your way in, though we recommend getting on at **Adams/Wabash** on your way out (unless you want to get a tour of the entire Chicago loop). While the Orange Line doesn't run 24/7 like the Blue, it does have regular service between 4:30 a.m. and 1 a.m., covering pretty much any reasonable flight departure/arrival times.
...
During business hours (9 a.m. to 4:30 p.m.), pass through security as a normal visitor. If arriving outside business hours, arrange for an CivicActions team member inside the office to escort you.
...
GSA onboarding is typically done on alternating Mondays at 1:00 p.m. in Room 3722, in the NW corner of the 37th floor. CivicActions onboarding varies by division-- you should receive an email confirming the times that you will meet with your team. To allow yourself enough time to get set up on the GSA network, please arrive at 8 a.m. on the second day of your first week, and Ethan Heppner (CivicActions Chicago's office operations coordinator) will help walk you through.
...
5. Look for rooms that have "JCK" in them, as those are the ones that are in the same building as the CivicActions office. _Make sure that you're not booking a room that is literally in Ohio._
...
Bathrooms are just down the hall from the CivicActions office.
...
Conference rooms: the CivicActions office has four quiet rooms (soon to be two quiet rooms and one conference room).
...
Have guests you want to bring to mingle with CivicActions?  Invite them to our monthly [potluck](https://www.eventbrite.com/e/civicactions-chicago-potluck-lunch-tickets-25357936270).  Potlucks are the first Tuesdays of each month (unless there is a holiday that Monday i.e. July 4 or Labor Day).
