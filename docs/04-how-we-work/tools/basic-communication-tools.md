...
* Google Docs are shared with your CivicActions email account
    * It is a security violation to share a Google Doc with your personal (non-CivicActions) email account
...
* When you create a document, set permissions so "anyone at CivicActions can find and access" ("comment" and "edit" permissions are also available for use)
