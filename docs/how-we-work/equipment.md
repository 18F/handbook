...
GSA issues every CivicActions employee a badge, laptop, and phone. Your MacBook should be ready before your first day, but your phone may not be. The Ops Team submits phone requests to IT on your behalf, and you'll receive a confirmation email within a few weeks when your phone is ready for pickup.
...
All CivicActions employees are issued an Apple MacBook Air/Pro computer. Note that this is not the norm for GSA.
...
If CivicActions-issued equipment fails due to manufacturer defects or accidental damage:

- CivicActions will cover the full cost of repairs or replacement of the device, regardless of the warranty status of the device. This applies to all CivicActions-issued hardware and peripherals.
...
- If either your laptop or your phone is in need of repair, please go to [#teamops](https://civicactions.slack.com/messages/teamops/) for advice. They will likely either ask you to take it to an Apple Store (CivicActions will pay for the repairs), or ship it back to CivicActions (we'll ship you a new laptop).

## <a id="stolen-or-lost">Lost or stolen equipment</a>

If CivicActions issued equipment is lost or stolen, follow these mandatory steps.  Employees must follow the GSA procedures for lost or stolen equipment or missing PIV cards, and alert CivicActions in [#equipment](https://civicactions.slack.com/messages/equipment):
...
CivicActions will replace stolen or lost equipment once a copy of the police report is sent to Team Ops and the employee confirms they contacted FPS.

## Requirements for passwords

As you set up your CivicActions accounts and devices, we have three requirements for making passwords that reduce security risks: use a password manager, use unique passwords, and use stronger passwords.
...
[**1Password**](https://1password.com/) and [**KeePassX**](https://www.keepassx.org/) are password managers approved for work at CivicActions. You can get a license for 1Password by asking [civicactionssoftware@gsa.gov](mailto:civicactionssoftware@gsa.gov). KeePassX is free.
