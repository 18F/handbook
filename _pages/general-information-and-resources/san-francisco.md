...
If you're based in SF and would like to regularly access the building after hours (6pm-6am), fill out the [50 UNP Security Access Card Application](https://drive.google.com/open?id=1KW2Vv11KYoZ70ajCQliPi3O11HanUXx_). Have a supervisor ("Director") sign it for you, then take it to the Operations Coordinator in the [Building Manager's](#helpful-contacts) office, located in room 0651 in the Basement, which is open 8:00am - 4:30pm. You may also scan and email the form to [Ahmed Mahdi](mailto:Ahmed.Mahdi@aleutmgt.com), the Operations Coordinator. He'll send the form to the Golden Gate Security Office, and email you once your application has been approved. You'll then need to go in-person to his office to register your PIV card and choose an access code, which you'll be able to use at the SW entrance to the building.
...
The SF office has small team rooms. You can book other conference rooms using [BookIt!]({{site.baseurl}}/getting-started/tts-classes/gsa-internal-tools/#bookit) Recommended rooms include Yuma and Carson City, because they are videoconference-friendly.
