...
Check the [GEAR, IT Standards list](https://ea.gsa.gov/#!/applications) (must be on GSA wireless or [VPN]({{site.baseurl}}/citrix)) to ensure the software you need is currently approved by GSA IT.
