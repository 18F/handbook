...
You can also check the [GEAR system](ea.gsa.gov/#!/applications) (must be on GSA wireless or [VPN](/vmware-horizon/#logging-into-vmware-horizon)) to find the list of software that is currently approved by GSA IT.
