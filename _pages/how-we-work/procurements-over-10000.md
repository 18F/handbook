...
- If your request is for a software, please note that it is your responsibility to you get an Authority to Operate (ATO). It is because GSA IT asks technical questions to check on the security and you are probably the best POC to answer their questions. The steps to find or get an ATO is outlined in [TTS Handbook-Software-ATO]({{site.baseurl}}/software/#step-1-find-or-get-an-ato) section.
