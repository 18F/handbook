...
- [coffeemate](https://gsa-tts.slack.com/team/coffeemate): send a message with `coffee me` in a public channel or direct message @Charlie (El Hubot Real) with `coffee me` to set up a virtual coffee/tea with a random coworker.
