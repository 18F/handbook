...
([_Having trouble with the link?_](#having-trouble)) Since the EFT form contains personal information, you might want to encrypt it and add a password before sending over email. Share the password to the file using a different channel, like a phone call.
