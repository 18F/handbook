...
* *login.gov note:* If the reported issue involves **[login.gov](https://login.gov)** and is scored **moderate or higher**, the first responder **must** mention [#identity-events](https://gsa-tts.slack.com/messages/identity-events/) in the [#incident-response](https://gsa-tts.slack.com/messages/incident-response) Slack channel and email **[`security@login.gov`](mailto:security@login.gov)**, so the login.gov team can help determine impact and respond to incidents.
