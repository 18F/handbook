...
- [coffeemate](https://app.slack.com/client/T025AQGAN/D01NBG7T3PF): send a message with `coffee me` in a public channel or direct message [@Charlie](https://app.slack.com/client/T025AQGAN/D01NBG7T3PF) with `coffee me` to set up a virtual coffee/tea with a random coworker.
