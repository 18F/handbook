...
2. Two paths: 
   ...
   \* Click on the Shortcuts button to the left of the message field (blue lightning bolt icon), select "Request new emoji"

   OR

   \* Click on the  channel name, and in the Integrations tab, find the Workflows section. Select `Run` next to "Request new emoji"
