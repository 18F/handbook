...
The Writing Lab team knows that writing is hard: It can be time-consuming, stress-inducing, and can sometimes seems like a blocker to a project that’s humming along. That's why the Writing Lab came into being. The Lab is a virtual writing center where you can get personalized help from members of the 18F editorial team. (And, if you’re a writerly type yourself, you can join the Lab team and volunteer to help other folks with their writing and editorial projects!)
...
- [18F Blogging Guide](https://blogging-guide.18f.gov/): Your guide to writing, editing, and publishing posts for the 18F blog
