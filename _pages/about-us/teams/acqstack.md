...
* **Talk to industry!** We are comfortable having conversations with industry as the FAR advises us to do. 
  * But what about **non-disclosure agreements** (NDAs)? What if a vendor says we need sign their NDA for us to do market research?
    * As government employees we aren’t allowed to sign other companies' NDAs in our professional capacity without going through the Office of General Counsel (OGC), and likely taking months of negotiations. The guidance OGC has provided is:
